...
<!-- 							<th>ID</th> -->
					...
					<tbody>
						...
						<c:forEach var="books" items="${booksByID}">

 							<c:url var="ReturnBook" value="/Students/ReturnBook">
...
<%-- 								<td class="text-center">${books.id}</td> --%>
							...
							<%-- 	<td class="text-center">${books.bookInStock}</td> --%>
								...
								<td class="text-right"><a href="${ReturnBook}"
									class="btn btn-primary" type="button">Return Book</a>
