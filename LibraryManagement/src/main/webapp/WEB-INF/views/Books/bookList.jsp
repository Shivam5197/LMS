...
<div class="row">
			<div class="col-2">
				<div class="card shadow-lg">
					<a class="btn" href="/BookManagement/showFormForBookSave">Add new Book</a>
				</div>
			</div>
				...
				<table class="display" id="table_id">
					...
					<tbody>
						...
						<c:forEach var="books" items="${bookList}">
							...
							<c:url var="updateBook" value="/BookManagement/updateBookShowForm">
...
<%-- 							<c:set var="course" scope="session" value="${student.course}" /> --%>
							...
							<tr>
								...
								<td class="text-right"><a href="${updateBook }"
									class="btn btn-primary" type="button">Update</a> <a
									href="${deleteBook }" class="btn btn-danger" type="button">Delete</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
